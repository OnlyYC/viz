 ...
 * @author liaoyanbo
 */
public enum GroupConversionEnum {
    //日期=====================================================================================
    /**
     * mysql 按时分秒
     */
     ...
     */
    public String convertColumn(String column) {
        throw new NotImplementedException(this.name() + "分组转换未实现");
    }
    ...
    GroupConversionEnum(List<String> conversions, String remark, List<DatabaseTypeEnum> databaseTypeEnums, List<MetadataColumnTypeEnum> columnTypeEnums) {
        this.conversions = conversions;
        this.remark = remark;
        this.databaseTypeEnums = databaseTypeEnums;
        this.columnTypeEnums = columnTypeEnums;
        Assert.notNull(conversions);
        Assert.notNull(databaseTypeEnums);
        Assert.notNull(columnTypeEnums);
    }
